                    ...
                    <div class="flex gap-3 w-1/2">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-1">
                                <x-text-input form="receive" datepicker datepicker-autohide id="date"
                ...
                <div class="mt-10 float-right w-1/2">
                    ...
                    {{-- <div class="mt-4 flex justify-between items-center">
                        <div class="flex gap-1 items-center">
                            ...
                            <x-text-input form="receive" id="cut" class="block mt-1 w-12" type="text"
                                name="cut" :value="old('cut')" autofocus autocomplete="tax" placeholder="" />
                            %
                        </div>
                    ...
                    <div class="mt-6 float-right">
                        ...
                        <x-primary-button form="receive" class="ml-2">
                            Simpan
                        </x-primary-button>
                    </div>
                </div>
